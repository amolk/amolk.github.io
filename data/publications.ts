...
export const publications: Publication[] = [
  ...
  { title: 'Bertrand-DR: Improving Text-to-SQL using a Discriminative Re-ranker', authors: 'A Kelkar, R Relan, V Bhardwaj, S Vaichal, C Khatri, P Relan', year: 2020, venue: 'arXiv:2002.00557', type: 'paper', citations: 32, link: 'https://arxiv.org/abs/2002.00557', selected: true },
  { title: 'Generation of complex database queries and API calls from natural language utterances', authors: 'A Kelkar, N Rajpurohit, U Mittal, P Relan', year: 2020, venue: 'arXiv:2012.08146', type: 'paper', citations: 0, link: 'https://arxiv.org/abs/2012.08146' },
  { title: 'Extended cascading style sheets', authors: 'AS Kelkar, JA Horne, R Parsell', year: 2016, venue: 'US Patent 9,229,915', type: 'patent', citations: 0, link: 'https://patents.google.com/patent/US9229915' },
