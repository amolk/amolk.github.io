...
It now has a public face under its own brand: a landing page that walks the folder → `git push` → chat-widget story, a dedicated documentation site, and an early-access waitlist open ahead of launch.
