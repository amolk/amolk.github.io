...
summary: "A short e-book coining **Harness Programming** - the discipline of composing the natural-language and configuration artifacts (prompts, skills, hooks, tools, memory) that shape how an AI agent behaves."
tags: ["agentic AI", "developer tools", "e-book"]
status: active
category: shipped
year_started: "2026"
is_public: false
